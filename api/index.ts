...
import { ASILO_BOT } from '../config.ts'
import { cacheHandler, type FullInformation } from '../utils/cache.ts'
import { PROVINCE_MAP } from '../utils/mapper.ts'
import { TEXT } from './constants.ts'
import { createLevelOneKeyboard, createLevelTwoKeyboard } from './keyboards.ts'

export const bot = new Bot(ASILO_BOT)
